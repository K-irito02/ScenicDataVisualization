    ...
    <el-card class="analysis-card">
      ...
      <div class="analysis-content">
        <el-alert
          ...
          :closable="false"
        >
          <p>1. 在各类型景区中，基本上都有免费的景区；</p>
          <p>2. 各类型景区中，收费价格最低不超过15元；</p>
          <p>3. 存在部分低价促销景区，最低价格与中位数差距较大。</p>
        </el-alert>
        ...
        <el-alert
          ...
          :closable="false"
        >
          <p>1. 大部分景区集中在周末9:00-17:00时段开放。</p>
          <p>2. 白天时段更符合游客出行习惯，且管理成本较低；夜间开放需要更高的安全维护和人力投入，同时游客需求相对有限。</p>
          <p>3. 早晨开放数量虽低于白天高峰，但仍显著高于夜间，可能反映了部分景区（如公园、晨练场所）对清晨时段的针对性开放策略。</p>
        </el-alert>
